          ...
          <>
            ...
            >
              ...
              >
                ...
                <MenuIcon open={open} className="h-6 w-6 stroke-puder" />
              </Popover.Button>
            </div>
              ...
              <a
                ...
                className={clsx(
                  ...
                  sectionIndex === activeIndex
                    ? 'border-puder bg-puder-light text-puder before:text-puder'
                    : 'border-transparent before:text-slate-500 hover:bg-puder-light hover:before:text-slate-900',
                )}
              >
                {section.title}
              </a>
