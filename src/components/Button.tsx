...
const variantStyles = {
  solid: {
    ...
    puder: 'bg-puder text-white hover:bg-puder-lighter focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 active:bg-blue-700 active:text-white/80 disabled:opacity-30 disabled:hover:bg-blue-600',
    ruder: 'bg-white text-puder hover:bg-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white active:bg-white active:text-white/80 disabled:opacity-30 disabled:hover:bg-white',
    white:
  ...
  outline: {
    ...
    blue: 'border-puder text-puder focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 active:text-blue-600/70 disabled:opacity-40 disabled:hover:border-puder disabled:hover:bg-transparent',
  },
}
